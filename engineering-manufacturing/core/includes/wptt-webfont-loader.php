...
if ( ! class_exists( 'Engineering_Manufacturing_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Engineering_Manufacturing_WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $engineering_manufacturing_css;
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Engineering_Manufacturing_WPTT_WebFont_Loader( $url );
